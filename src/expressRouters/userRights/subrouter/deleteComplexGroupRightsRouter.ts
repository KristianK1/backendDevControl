import { IDeleteUserRightComplexGroupReq } from "models/API/UserRightAlterReqRes";
...
router.post('/', async (req: any, res: any) => {
    let request: IDeleteUserRightComplexGroupReq = req.body;
    ...
    try {
        await db.deleteUserRightToComplexGroup(user, request.deviceId, request.complexGroupId);
